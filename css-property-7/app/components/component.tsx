export const Component = () => {
  ...
  return (
    ...
    >
      ...
      <p className="text-neutral-500 text-center max-w-sm text-sm mx-auto mb-8 bg-clip-text text-transparent bg-gradient-to-b from-neutral-800 to-neutral-400 dark:from-neutral-100 dark:to-neutral-600">
        Hover over the image below to see a smooth 3D transformation effect. The card rotate and scale using css transforms and Tailwind's build-in classes.
      </p>
      <div className={cn
        ...
        <img
          src="https://images.unsplash.com/photo-1663893364107-a6ecd06cf615?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          className={cn(
            ...
            "tranform rotate-x-30 rotate-z-30 -rotate-y-30 translate-z-20",
