...
export const SVGLines = () => {
  return (
    <motion.div
      whileHover="animate"
      className="text-neutral-900 rounded-md flex justify-between items-center max-w-md w-full"
    >
      <div className="flex flex-col gap-8 justify-between">
        <div className="relative gap-5 text-[10px]">
          Meeting Summarizer
      ...
      <div className="size-10 rounded-sm bg-neutral-100 relative overflow-hidden z-20 translate-x-3 p-px">
...
export const SVG = () => {
  return (
    <motion.svg
      ...
      viewBox="0 0 24 24"
      fill="currentColor"
      className="text-neutral-500 size-3"
    >
