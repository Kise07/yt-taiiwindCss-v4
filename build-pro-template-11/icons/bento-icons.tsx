export const RecentActityIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <div>
      <svg
        width="16"
...
export const SixthIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <div>
      <svg
        width="12"
...
export const SeventhIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <div>
      <svg
        width="12"
